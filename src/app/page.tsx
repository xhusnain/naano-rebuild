    ...
    <>
      ...
      <section className="nn-sky -mt-[63px] pt-[63px]">
        <div className="mx-auto max-w-[1180px] px-5 pb-16 pt-20 text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/[0.92] pb-[9px] pl-[14px] pr-[18px] pt-[9px] text-[16px] font-normal text-ink shadow-[0_1px_3px_rgba(15,23,42,0.08)] backdrop-blur">
            ...
            <span className="grid size-4 place-items-center rounded-[3px] bg-[#0a66c2] text-[9px] font-bold text-white">
              in
            </span>
            Where B2B brands work with creators
          </span>

          <h1 className="mx-auto mt-8 max-w-4xl font-display text-[clamp(2.6rem,5.35vw,77px)] font-semibold leading-[1.05] tracking-[-0.04em] text-ink">
            The B2B LinkedIn
            <br className="hidden sm:block" />
            {" Creator Marketplace."}
          </h1>

          <p className="mx-auto mt-7 max-w-[660px] text-[21px] leading-[31.5px] text-[#43454c]">
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-x-7 gap-y-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-ink px-7 py-4 text-[16px] font-semibold text-white transition hover:bg-ink-900"
            >
              Launch a campaign <span aria-hidden>→</span>
            </Link>
            <Link
              href="/#how"
              className="inline-flex items-center gap-2 text-[16px] font-semibold text-ink transition hover:text-brand"
            >
              See how Naano works <span aria-hidden>→</span>
            </Link>
          </div>

          <p className="mt-9 inline-flex items-center gap-2 text-[13px] font-medium text-ink-900/70">
          ...
          <div className="mx-auto mt-16 grid max-w-4xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-line bg-line md:grid-cols-4">
            {[
              ...
              <div key={l} className="bg-white/90 px-5 py-6 backdrop-blur">
