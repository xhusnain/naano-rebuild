...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="nn-sky -mt-[63px] pt-[63px]">
        <div className="mx-auto w-full max-w-[1440px] px-6 pb-14 pt-[148px] text-center lg:px-12">
          ...
          <h1 className="mx-auto mt-[34px] max-w-[900px] font-sans text-[clamp(2.6rem,5.35vw,77px)] font-semibold leading-[1.05] tracking-[-0.04em] text-[#17181c]">
            The B2B LinkedIn
            <br className="hidden sm:block" />
            {" Creator Marketplace."}
          </h1>

          <p className="mx-auto mt-[26px] max-w-[660px] text-[21px] leading-[31.5px] text-[#43454c]">
          ...
          <div className="mt-[38px] flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
            <Link
              href="/register?role=saas"
              className="inline-flex items-center gap-[11px] rounded-xl bg-[#17181c] px-7 py-[13px] text-[16px] font-semibold leading-none tracking-[-0.02em] text-white transition hover:opacity-90"
            >
            ...
            <Link
              href="/#how"
              className="inline-flex items-center gap-[11px] text-[16px] font-semibold leading-none tracking-[-0.02em] text-[#17181c] transition hover:opacity-70"
            >
          ...
          <p className="mt-[29px] inline-flex items-center gap-2 text-[15px] font-medium text-[#43454c]">
          ...
          <div className="nn-marquee-viewport mt-[41px] w-full">
