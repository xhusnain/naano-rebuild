...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* ---------------------------------------------------------------- hero */}
      <section className="nn-sky -mt-16 pt-16">
        <div className="mx-auto max-w-[1180px] px-5 pb-16 pt-20 text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/90 px-4 py-2 text-[13px] font-medium text-ink shadow-[0_1px_3px_rgba(15,23,42,0.08)] backdrop-blur">
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-x-7 gap-y-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-ink px-6 py-3.5 text-[15px] font-semibold text-white transition hover:bg-ink-900"
            >
              Launch a campaign <span aria-hidden>→</span>
            </Link>
            <Link
              href="/#how"
              className="inline-flex items-center gap-2 text-[15px] font-semibold text-ink transition hover:text-brand"
            >
